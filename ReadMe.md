...
The icon file needs to go into the same folder where the packages are located. In case of the example this would be a folder called "pkgs" because the server url is http://server.com/pkgs/ the json file needs to be put into /data/store on the PS4
